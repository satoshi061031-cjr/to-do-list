(function () {
  ...
  if (dueDayPageCloseBtn) dueDayPageCloseBtn.addEventListener("click", () => closeDueDayPage());
  if (dueDayPageBackdrop) dueDayPageBackdrop.addEventListener("click", () => closeDueDayPage());
