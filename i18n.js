(function () {
  ...
  const ZH = {
    ...
    More: "更多",
    "⌘K · ?": "⌘K · ?",
    "Enter to add · / commands · ⌘K jump · ? shortcuts": "回车添加 · / 命令 · ⌘K 跳转 · ? 快捷键",
    "Nothing due today.": "今天没有到期。",
    ...
    "Quiet tasks for today—check them off when done.": "安静完成今天的任务——做完就勾掉。",
    ...
    "Search a place, or click the map to drop a stop.": "搜索地点，或点击地图添加停留点。",
    "Back to trips": "返回行程列表",
    "Delete trip": "删除行程",
    Stops: "停留点",
    "Delete stop": "删除停留点",
    "No stops on this day yet.": "这一天还没有停留点。",
    ...
    "Stop added. Search again or click the map.": "已添加停留点。可继续搜索或点击地图。",
